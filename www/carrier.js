...
function Stream() {
    ...
    this.id = null;
    /** @property {TransportInfo} transportInfo Tranport info **/
...
Session.prototype = {
    ...
    request: function (onSuccess, onError, handler) {
        ...
        if (typeof handler == "function") {
            handlerId = this.carrierPlugin.addSessionRequestCompleteCB(handler, me);
        }
    ...
    addStream: function (onSuccess, onError, type, options, callbacks) {
        ...
        var _onSuccess = function (ret) {
            ...
            stream.id = ret.id;
            stream.transportInfo = ret.transportInfo;

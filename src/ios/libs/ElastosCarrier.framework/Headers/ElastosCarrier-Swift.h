...
@protocol FriendInviteResponseDelegate;
...
/// throws:
/// CarrierError
- (BOOL)sendInviteFriendRequestTo:(NSString * _Nonnull)target withData:(NSString * _Nonnull)data delegate:(id <FriendInviteResponseDelegate> _Nonnull)delegate error:(NSError * _Nullable * _Nullable)error;
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierCandidateType, "CandidateType") {
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierConnectionStatus, "CarrierConnectionStatus") {
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierLogLevel, "CarrierLogLevel") {
/// Log level None
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierNetworkTopology, "CarrierNetworkTopology") {
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierPresenceStatus, "CarrierPresenceStatus") {
...
@protocol SessionRequestCompleteDelegate;
...
/// throws:
/// CarrierError
- (BOOL)sendInviteRequestWithResponseHandler:(id <SessionRequestCompleteDelegate> _Nonnull)delegate error:(NSError * _Nullable * _Nullable)error;
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierStreamState, "CarrierStreamState") {
/// Initialized stream.
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACarrierStreamType, "CarrierStreamType") {
/// Audio stream
...
typedef SWIFT_ENUM_NAMED(NSInteger, ELACloseReason, "CloseReason") {
...
SWIFT_PROTOCOL_NAMED("FriendInviteResponseDelegate")
@protocol FriendInviteResponseDelegate
- (void)onReceived:(ELACarrier * _Nonnull)carrier :(NSString * _Nonnull)from :(NSInteger)status :(NSString * _Nullable)reason :(NSString * _Nullable)data;
@end

/// Port forwarding supported protocols.
typedef SWIFT_ENUM_NAMED(NSInteger, ELAPortForwardingProtocol, "PortForwardingProtocol") {
/// TCP protocol.
  ELAPortForwardingProtocolTCP = 1,
};


SWIFT_PROTOCOL_NAMED("SessionRequestCompleteDelegate")
@protocol SessionRequestCompleteDelegate
- (void)onCompletion:(ELACarrierSession * _Nonnull)session :(NSInteger)status :(NSString * _Nullable)reason :(NSString * _Nullable)sdp;
@end
